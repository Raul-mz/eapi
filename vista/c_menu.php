...
$perfil=new Tabla($resultado);
$r_Obt = $resultado->obtResultado($tabla);
?>
<p>&nbsp; </p>
<p>&nbsp; </p>
    
      <p ><div class=" r col-md-offset-3"><h2>Menu</h2></div> </p>
...
<div >
                            ...
                            <div align="right"><input class="btn btn-primary" type="submit" name="boton" onclick="nuevo('<?php echo 'r_'.$tabla?>')" value="Registrar" /></div>
                                        ...
                                        <tr id="listar">
                                        <?php foreach ($perfil->getMenu() as $i => $value) { ?>
                                          <th ><div align="center" class="t"><?php echo $value; ?></div></th>
                                         <?php } ?> 
