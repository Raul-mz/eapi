...
if($id==""){
$usuarios_reg = $datosUsu->obtResultadoW($Tabla,'id_permiso',$texto[1]);
/* ************************/
if (!empty($usuarios_reg))
{//si el permiso esta registrado
echo "<div id='msj' align='center' class='c'>Este permiso ya está Registrado  <a onClick=\"newRecord('permiso')\">Volver</a></div>";
