...
{//si el empleado esta registrado
echo "<div id='msj' align='center' class='c'>Este empleado ya está Registrado  <a onClick=\"newRecord('empleado')\">Volver</a></div>";
